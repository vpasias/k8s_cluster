...
sshpass -f /home/iason/k8s_cluster/rocky ssh -o StrictHostKeyChecking=no root@node-1 "rm /etc/containerd/config.toml && systemctl restart containerd && systemctl restart docker"
